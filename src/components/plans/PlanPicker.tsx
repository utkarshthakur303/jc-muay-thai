    ...
    <form action={formAction}>
      ...
      */}
      ...
      {/*
        ...
        actually use the site for. It submits an empty slug, which stores a
        row with no plan — a real answer, recorded, so nobody is asked
        twice. It is a quiet link rather than another card because it is an
        escape hatch, not another option.
      */}
